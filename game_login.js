...
function check()
{
	...
	if(answer == word)	//answer = resposta e word = pergunta//
	{
		if(answerTurn == "player1") //é uma ariavel responsavel para vericar quem está respondendo//
		{
	...
	if(questionTurn == "player1") //é a ariave de fazer a pergunta//
	{
...
function check()
{
    ...
    document.getElementById("output").innerHTML = "";//Utilizamos id=”output”, pois, a id é definida com um elemento HTML div, em game_page.html, para conter a palavra pergunta, a input box e o botão Checar.//
}
